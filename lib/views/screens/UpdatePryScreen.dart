...
class UpdatePryScreen extends StatelessWidget{
  AllPryCatModel allPryCatModel;
  UpdatePryScreen(this.allPryCatModel);
  GlobalKey<FormState> pryKey = GlobalKey();
  @override
            ...
            appBar: AppBar(
              ...
              leading:Row(
                children: [
                  ...
                  IconButton(
                      onPressed: (){
                    if(pryKey.currentState!.validate()){
                      provider.updateMyPry(allPryCatModel);
                      AppRouter.NavigateToWidget(PryringScreen());
                      ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            backgroundColor:SettingScreen.isGreen?Color(0xFF344F24):Colors.black,
                            content: Text('تم تعديل الدعاء',textAlign: TextAlign.center,style: GoogleFonts.reemKufi(fontSize: 20.sp)),
                          ));
                    }
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      CustomField(textInputType:TextInputType.name ,hint:'الدعاء',validator:provider.validateNull ,controller:provider.pryNameController ,),
                      SizedBox(height: 50.h,),
                      CustomField(textInputType:TextInputType.number ,hint:'مرات التكرار',validator:provider.validateCount ,controller:provider.pryCountController ,)
                    ],
                  ),
                ),
              ),
